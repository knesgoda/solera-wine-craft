      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="border-none shadow-md">
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            {order.stripe_session_id && <div className="flex justify-between"><span className="text-muted-foreground">Stripe Session</span><span className="text-xs truncate max-w-[200px]">{order.stripe_session_id}</span></div>}
