...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { question: "What happens to my DTC transaction fees?", answer: "You pay standard payment processing fees — Solera adds zero markup. Many competitors add 1–3% on top of processing." },
