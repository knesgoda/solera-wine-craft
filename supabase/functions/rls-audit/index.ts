...
const DIRECT: { t: string; c?: Record<string, unknown> }[] = [
  ...
  { t: "inventory_adjustments", c: { sku_id: "__SKU_A__", cases_delta: 1, bottles_delta: 0, reason: "production" } },
  { t: "inventory_skus", c: { label: "TW" } },
  { t: "lot_cost_summaries", c: { vintage_id: "__VIN_A__" } },
  { t: "material_unit_costs", c: { name: "TM", unit: "kg", cost_per_unit: 1 } },
  { t: "notifications", c: { user_id: "__UA__", message: "t", type: "alert", channel: "in_app" } },
  ...
  { t: "tasks", c: { title: "TT" } },
  { t: "ttb_additions", c: { vintage_id: "__VIN_A__", addition_type: "fining", amount: 1, unit: "g_l" } },
  ...
  { t: "webhook_subscriptions", c: { target_url: "__skip__" } },
  { t: "weekly_summaries", c: { week_of: "2099-01-06" } },
