...
const DIRECT: { t: string; c?: Record<string, unknown> }[] = [
  ...
  { t: "tasks", c: { title: "TT" } },
  { t: "ttb_additions", c: { vintage_id: "__VIN_A__", addition_type: "fining_agent", amount: 1, unit: "g_l" } },
  ...
  { t: "webhook_subscriptions", c: { event_type: "vintage.created", endpoint_url: "https://t.com/h" } },
