...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const notifInserts = [
      { org_id: orgId, user_id: userId, message: "Cascade test notification 1", type: "alert" as const },
      { org_id: orgId, user_id: userId, message: "Cascade test notification 2", type: "system" as const },
    ];
